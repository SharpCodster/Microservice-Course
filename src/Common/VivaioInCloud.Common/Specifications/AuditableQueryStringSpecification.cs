...
{
    public class AuditableQueryStringSpecification<T> : Specification<T>
        where T : class, IIdentified, IAuditableUtc, new()
    {
        protected AuditableQueryStringSpecification() : base()
        {
        }
        ...
        public AuditableQueryStringSpecification(Dictionary<string, string> queryString) : this()
        {
